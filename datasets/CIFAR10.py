...
class CIFAR10(object):
    def __init__(self, dataFolder=None, pin_memory=False):
        ...
        self.dataFolder = dataFolder if dataFolder is not None else os.path.join(datasets.BASE_DATA_FOLDER, 'data')
        self.pin_memory = pin_memory
        self.meanStd = meanstd
        #download the dataset
        torchvision.datasets.CIFAR10(self.dataFolder, download=False)
